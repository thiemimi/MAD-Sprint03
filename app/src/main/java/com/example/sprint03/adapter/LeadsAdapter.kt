...
import com.example.sprint03.view.fragments.list.LeadListFragmentDirections
...
class LeadsAdapter : ListAdapter<Lead, LeadsAdapter.MyViewHolder>(AsyncCallback()) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        val binding: ListItemLeadBinding = ListItemLeadBinding.inflate(layoutInflater, parent, false)
